...
public class BenController {
	...
	//Lấy danh sách bến tới khi đã có điểm xuất phát
	...
	//Lấy danh sách điểm đón theo điểm xuất phát
	...
	//Lấy danh sách điểm đón (full, không biết để làm gì)
